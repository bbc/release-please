...
describe('GitHub', () => {
  ...
  describe('create', () => {
    ...
    it('fetch is undefined when no proxy option passed ', () => {
      expect(GitHub.createDefaultFetch()).eq(undefined);
    });

    it('should return a undici fetch instance', () => {
      expect(GitHub.createDefaultFetch('http://proxy.com:3000')).not.eq(
        undefined
      );
    });
  });
